...
<head>
    ...
    <title>Cost Report - {{ $dateRange }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="summary-box">
        ...
        <div class="summary-item">
            ...
            <span class="summary-value">{{ $highestCost['location'] ?? 'N/A' }} - PHP {{ number_format($highestCost['cost'] ?? 0, 2) }}</span>
        </div>
        <div class="summary-item">
            <span class="summary-label">Lowest Cost:</span>
            <span class="summary-value">{{ $lowestCost['location'] ?? 'N/A' }} - PHP {{ number_format($lowestCost['cost'] ?? 0, 2) }}</span>
        </div>
        <div class="summary-item">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <span class="badge badge-{{ $item['badge_class'] }}">{{ $item['cost_level'] }}</span>
                </td>
            </tr>
            @empty
            <tr>
