    ...
    if (printDssButton) {
        printDssButton.addEventListener('click', function () {
            ...
            printWindow.document.write(`<!doctype html><html><head><title>CampFix Executive Maintenance Analytics Report</title><style>
                @page { size: A4 portrait; margin: 48mm 14mm 32mm; }
                *{box-sizing:border-box} body{margin:0;color:#263a55;font:10pt/1.48 Arial,sans-serif}
                .print-header{position:fixed;top:-42mm;left:0;right:0;height:35mm;display:grid;grid-template-columns:34mm 1fr 34mm;align-items:center;padding:0 8mm 4mm;border-bottom:1px solid #111;color:#111;text-align:center;font-family:Arial,sans-serif}
                ...
                .print-footer{position:fixed;bottom:-26mm;left:0;right:0;height:20mm;display:grid;grid-template-columns:18mm 1fr 32mm;align-items:center;padding:3mm 5mm 0;border-top:1px solid #111;color:#111;font-family:Arial,sans-serif}.print-footer img{width:14mm;height:14mm;object-fit:contain}.print-footer .footer-copy{font-size:6.7pt;line-height:1.4}.print-footer .footer-copy strong{font-size:7pt}.print-footer .brand{text-align:right;color:#1769e0;font-weight:800;font-size:14pt;letter-spacing:1px}.print-footer .brand small{display:block;color:#66758a;font-size:5.5pt;letter-spacing:0}
            ...
            </style></head><body><header class="print-header"><img src="${stiSeal}" alt="STI academic seal"><div><div class="school">STI COLLEGE NOVALICHES</div><div class="address">STI Academic Center, Diamond Avenue corner Quirino Highway<br>San Bartolome, Novaliches, Quezon City, 1116 Metro Manila</div><div class="system">CAMPFIX DECISION SUPPORT SYSTEM</div></div><img src="${campfixLogo}" alt="CampFix logo"></header><footer class="print-footer"><img src="${stiSeal}" alt="STI academic seal"><div class="footer-copy"><strong>STI COLLEGE NOVALICHES</strong><br>STI Academic Center, Diamond Avenue corner Quirino Highway, San Bartolome, Novaliches, Quezon City, 1116 Metro Manila<br>www.sti.edu &nbsp;|&nbsp; CampFix Decision Support System &nbsp;|&nbsp; Generated by ${escapeHtml(generatedBy)}</div><div class="brand">CAMPFIX<small>Executive Maintenance Analytics</small></div></footer>${report.outerHTML}<section class="dss-print-charts"><h2>Appendix B. Analytics Visualizations</h2><div class="charts">${printableCharts}</div></section></body></html>`);
            printWindow.document.close();
            printWindow.focus();
