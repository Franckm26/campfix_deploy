...
<article class="dss-report" id="dssExecutiveReportContent">
    ...
    <section class="dss-report-section">
        ...
        @if($totalReports > 0)
            ...
            @if($executiveSummary['top_recurring_issue'])<p>The leading recurring issue is <strong>{{ $executiveSummary['top_recurring_issue']['issue'] }}</strong>, recorded {{ number_format($executiveSummary['top_recurring_issue']['count']) }} times with {{ number_format($executiveSummary['top_recurring_issue']['repair_cycles']) }} completed repair cycle(s) and PHP {{ number_format($executiveSummary['top_recurring_issue']['cost'], 2) }} in recorded repair cost. @if($executiveSummary['top_recurring_issue']['replacement_candidate']) Management should compare projected repair spending with a replacement quotation before approving another repair. @else A root-cause inspection should be completed before this becomes a repeated repair expense. @endif</p>@endif
        @else
