...
<article class="dss-report" id="dssExecutiveReportContent">
    <header class="dss-report-cover">
        ...
        <div class="dss-report-letterhead">
            <div class="dss-report-title">CampFix: A Web-Based Platform for Campus Facility Requests, Concern Reporting, and Data-Driven Decision Support for STI College Novaliches</div>
            <div class="dss-report-address">STI Academic Center, Diamond Avenue corner Quirino Highway<br>San Bartolome, Novaliches, Quezon City, 1116 Metro Manila</div>
        </div>
