...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/auth-otp-choice.css') }}">
</head>
<body>
        ...
        <div class="form-group">
            <label class="radio-label" id="email-option">
                ...
                <span class="radio-text">
                    ...
                    Send to email: <strong>{{ session('otp_email', 'your email') }}</strong>
                </span>
            </label>
        </div>
...
<script src="{{ asset('js/auth-otp-choice.js') }}"></script>
