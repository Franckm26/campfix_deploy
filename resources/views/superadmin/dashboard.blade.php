...
<div class="row g-3 mb-2">
    ...
    <div class="col-6 col-md-3 col-xl-2">
        <a href="{{ route('admin.users', ['view'=>'locked']) }}" class="module-card red">
            ...
            <div class="module-sub">{{ $stats['locked_users'] > 0 ? 'Needs attention' : 'All clear' }}</div>
        </a>
    </div>
    <div class="col-6 col-md-3 col-xl-2">
...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-md-3 col-xl-2">
        <a href="{{ route('admin.logs') }}" class="module-card pink">
            ...
            <div class="module-title">Forensic Audit Logs</div>
    ...
    <div class="col-md-4">
        <div class="sa-card h-100">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;padding:8px 0;border-bottom:1px solid var(--sa-border)">
                <span class="sa-badge {{ $roleColors[$role] ?? 'sa-badge-gray' }}">{{ str_replace('_', ' ', ucfirst($role)) }}</span>
                <span style="font-weight:700;color:var(--sa-text)">{{ $count }}</span>
            </div>
            @empty
...
const concernData = @json($concernTrend);
