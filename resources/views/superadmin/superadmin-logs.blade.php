...
<div class="sa-card mb-4">
    <form method="GET" action="{{ \App\Support\ProtectedRoute::url('superadmin.superadmin-logs') }}" style="display:flex;flex-wrap:wrap;gap:10px;align-items:flex-end">
        ...
        <a href="{{ \App\Support\ProtectedRoute::url('superadmin.superadmin-logs') }}" class="sa-btn sa-btn-ghost">Reset</a>
    </form>
</div>
