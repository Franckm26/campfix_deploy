...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/admin/management/event-setup/education-levels', [\App\Http\Controllers\ManagementController::class, 'storeEventEducationLevel'])->name('admin.management.event-education-levels.store');
