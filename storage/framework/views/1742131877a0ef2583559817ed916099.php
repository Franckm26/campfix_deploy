...
<div class="container-fluid px-3">
    ...
    <div class="card mb-4">
        <div class="card-body py-3">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($viewType ?? 'active') == 'active' ? 'active' : ''); ?>" href="<?php echo e(route('reports.assigned', ['view' => 'active'])); ?>">
                        <i class="fas fa-list"></i> Active (<?php echo e($activeCount ?? 0); ?>)
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($viewType ?? '') == 'archives' ? 'active' : ''); ?>" href="<?php echo e(route('reports.assigned', ['view' => 'archives'])); ?>">
                        <i class="fas fa-archive"></i> Archived (<?php echo e($archiveCount ?? 0); ?>)
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('reports.assigned')); ?>" class="row g-2 align-items-end">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="Search reports..." value="<?php echo e(request('search')); ?>">
                </div>
                <div class="col-auto">
                    <button type="submit" class="btn btn-primary">Filter</button>
                </div>
                <div class="col-auto">
                    <a href="<?php echo e(route('reports.assigned')); ?>" class="btn btn-secondary"><i class="fas fa-times"></i> Clear</a>
                </div>
            </form>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Campfix\resources\views/reports/assigned.blade.php ENDPATH**/ ?>