...
<div class="container-fluid px-3">
            ...
            <div class="row align-items-center g-2">
                <div class="col-md-5">
                    <ul class="nav nav-pills mb-0">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(($viewType ?? 'active') == 'active' ? 'active' : ''); ?>" href="<?php echo e(route('admin.users', ['view' => 'active'])); ?>">
                                <i class="fas fa-users"></i> Active Users
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(($viewType ?? '') == 'archives' ? 'active' : ''); ?>" href="<?php echo e(route('admin.users', ['view' => 'archives'])); ?>">
                                <i class="fas fa-folder"></i> Archive Folders
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(($viewType ?? '') == 'deleted' ? 'active' : ''); ?>" href="<?php echo e(route('admin.users', ['view' => 'deleted'])); ?>" style="color: #dc3545;">
                                <i class="fas fa-trash-alt"></i> Deleted Users
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(($viewType ?? '') == 'locked' ? 'active' : ''); ?>" href="<?php echo e(route('admin.users', ['view' => 'locked'])); ?>" style="color: #fd7e14;">
                                <i class="fas fa-lock"></i> Locked Users
                                <?php if(isset($lockedCount) && $lockedCount > 0): ?>
                                    <span class="badge bg-danger ms-1"><?php echo e($lockedCount); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="col-md-7">
                    <form method="GET" action="<?php echo e(route('admin.users')); ?>" class="row g-2 align-items-center" id="userFilterForm">
                        ...
                        <div class="col-auto">
                            <input type="text" name="search" id="searchInput" class="form-control form-control-sm" placeholder="Search Name, Email..." 
                                value="<?php echo e(request('search')); ?>" onkeyup="filterTable()">
                        </div>
                        <div class="col-auto">
                            <select name="role" class="form-select form-select-sm" onchange="this.form.submit()">
                                ...
                                <option value="academic_head" <?php echo e(request('role') == 'academic_head' ? 'selected' : ''); ?>>Academic Head</option>
                                <option value="program_head" <?php echo e(request('role') == 'program_head' ? 'selected' : ''); ?>>Program Head</option>
                                <option value="principal_assistant" <?php echo e(request('role') == 'principal_assistant' ? 'selected' : ''); ?>>Principal Assistant</option>
                            </select>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <a href="<?php echo e(route('admin.users', ['view' => $viewType ?? 'active'])); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-times"></i></a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="card" style="display: block !important;">
        <div class="card-body" style="display: block !important;">
            ...
            <ul class="nav nav-tabs mb-3" id="roleTabNav">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(!request('role_filter') ? 'active' : ''); ?>" href="<?php echo e(route('admin.users', array_merge(request()->except('role_filter'), ['view' => $viewType ?? 'active']))); ?>">
                        All
                        <span class="badge bg-secondary ms-1"><?php echo e($totalAll ?? 0); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('role_filter') == 'student' ? 'active' : ''); ?>" href="<?php echo e(route('admin.users', array_merge(request()->except('role_filter'), ['view' => $viewType ?? 'active', 'role_filter' => 'student']))); ?>">
                        Student
                        <span class="badge bg-primary ms-1"><?php echo e($totalStudent ?? 0); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('role_filter') == 'faculty' ? 'active' : ''); ?>" href="<?php echo e(route('admin.users', array_merge(request()->except('role_filter'), ['view' => $viewType ?? 'active', 'role_filter' => 'faculty']))); ?>">
                        Faculty
                        <span class="badge bg-info ms-1"><?php echo e($totalFaculty ?? 0); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request('role_filter') == 'staff' ? 'active' : ''); ?>" href="<?php echo e(route('admin.users', array_merge(request()->except('role_filter'), ['view' => $viewType ?? 'active', 'role_filter' => 'staff']))); ?>">
                        Staff
                        <span class="badge bg-warning ms-1"><?php echo e($totalStaff ?? 0); ?></span>
                    </a>
                </li>
            </ul>
                ...
                <table class="table table-hover" style="display: table !important;">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-id="<?php echo e($user->id); ?>" data-role="<?php echo e($user->role); ?>" data-archived="<?php echo e($user->is_archived ? '1' : '0'); ?>">
                                <td style="width:1%;white-space:nowrap;text-align:center"><input type="checkbox" class="user-checkbox" value="<?php echo e($user->id); ?>" onchange="updateSelectedCount()"></td>
                            ...
                            <!-- View User Modal -->
                            <div class="modal fade" id="viewUserModal<?php echo e($user->id); ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">User Details: <?php echo e($user->name); ?></h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <p><?php echo e($user->department ?? 'N/A'); ?></p>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label fw-bold">Phone</label>
                                                    <p><?php echo e($user->phone ?? 'N/A'); ?></p>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label fw-bold">STI ID</label>
                                                    <p><?php echo e($user->sti_id ?? 'N/A'); ?></p>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label fw-bold">Created At</label>
                                                    <p><?php echo e($user->created_at->format('M d, Y h:i A')); ?></p>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label fw-bold">Last Updated</label>
                                                    <p><?php echo e($user->updated_at->format('M d, Y h:i A')); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
            ...
            <div class="text-muted mt-3 small text-center">
                Total active users: <?php echo e($users->total()); ?>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $archiveFolders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <i class="fas fa-folder text-warning"></i> 
                                    <strong><?php echo e($folder->name); ?></strong>
                                </td>
                                <td><?php echo e($folder->description ?? 'No description'); ?></td>
                                <td><span class="badge bg-primary"><?php echo e($folder->user_count); ?> users</span></td>
                            ...
                            <div class="modal fade" id="deleteFolderModal<?php echo e($folder->id); ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Are you sure you want to delete the folder <strong><?php echo e($folder->name); ?></strong>?</p>
                                            <p class="text-danger"><?php echo e($folder->user_count); ?> users in this folder will be permanently deleted!</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                            <form action="<?php echo e(route('admin.archiveFolder.delete', $folder->id)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
        ...
        <div class="card-body bg-warning bg-opacity-10">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-end">
                    <span class="badge bg-warning fs-5"><?php echo e($deletedUsers->count() ?? 0); ?> users</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    ...
                    ">
                        <option value="3" <?php echo e((isset($days) && $days == 3) ? 'selected' : ''); ?>>3 days</option>
                        <option value="7" <?php echo e((isset($days) && $days == 7) ? 'selected' : ''); ?>>7 days</option>
                        <option value="15" <?php echo e((!isset($days) || $days == 15) ? 'selected' : ''); ?>>15 days</option>
                        <option value="30" <?php echo e((isset($days) && $days == 30) ? 'selected' : ''); ?>>30 days</option>
                    </select>
                </div>
            </div>
        </div>
    ...
    <!-- Bulk Actions -->
    <?php if(($deletedUsers->count() ?? 0) > 0): ?>
    <div class="card mb-3">
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <form method="POST" action="<?php echo e(route('admin.deletedUsers.restoreAll')); ?>">
                        <?php echo csrf_field(); ?>
            ...
            <?php if(isset($deletedUsers) && $deletedUsers->count() > 0): ?>
                <div class="table-responsive" style="display: block !important; visibility: visible !important; opacity: 1 !important;">
                    <table class="table table-hover" style="display: table !important;" id="deletedUsersTable">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $deletedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr data-id="<?php echo e($user->id); ?>">
                                    <td style="width:1%;white-space:nowrap;text-align:center"><input type="checkbox" class="deleted-user-checkbox" value="<?php echo e($user->id); ?>" onchange="deletedUsersUpdateSelectedCount()"></td>
                                    <td><?php echo e($user->name); ?></td>
                                    <td><?php echo e($user->email); ?></td>
                                    <td>
                                        <?php
                                    ...
                                    <td><?php echo e($user->deletedBy ? $user->deletedBy->name : 'System'); ?></td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <form action="<?php echo e(route('admin.deletedUsers.restore', $user->id)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <form action="<?php echo e(route('admin.deletedUsers.permanentDelete', $user->id)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                ...
                                <div class="modal fade" id="deletedUsersPermanentDeleteModal<?php echo e($user->id); ?>" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Are you sure you want to permanently delete <strong><?php echo e($user->name); ?></strong>?</p>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div class="text-muted small">
                        Showing <?php echo e($deletedUsers->firstItem() ?? 0); ?> to <?php echo e($deletedUsers->lastItem() ?? 0); ?> of <?php echo e($deletedUsers->total()); ?> deleted users
                    </div>
                    <div>
                        <?php echo e($deletedUsers->appends(request()->except('page'))->links('pagination::bootstrap-4')); ?>
    ...
    <div class="card">
        <div class="card-body p-0">
            <?php if(isset($lockedUsersList) && $lockedUsersList->count() > 0): ?>
                <div class="table-responsive">
                    <table class="table table-hover mb-0" style="font-size:13px">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $lockedUsersList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="ps-3 fw-semibold"><?php echo e($lu->name); ?></td>
                                    <td class="text-muted"><?php echo e($lu->email); ?></td>
                                    <td>
                                        <span class="badge bg-secondary"><?php echo e(ucfirst(str_replace('_', ' ', $lu->role))); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge bg-danger"><?php echo e($lu->failed_login_attempts); ?></span>
                                    </td>
                ...
                <div class="d-flex justify-content-between align-items-center px-3 py-2">
                    <small class="text-muted"><?php echo e($lockedUsersList->total()); ?> locked account(s)</small>
                    <?php echo e($lockedUsersList->links('pagination::bootstrap-4')); ?>
...
<?php if(($viewType ?? '') == 'deleted' && isset($deletedUsers)): ?>
<div class="modal fade" id="deletedUsersPermanentDeleteAllModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to permanently delete all <strong><?php echo e($deletedUsers->count()); ?></strong> users?</p>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <form action="<?php echo e(route('admin.deletedUsers.permanentDeleteAll')); ?>" method="POST" class="d-inline">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.users.store')); ?>" method="POST" id="addUserForm" novalidate>
                ...
                <div class="modal-body">
                    ...
                    <?php if($errors->hasAny(['name','email','password','phone','role'])): ?>
                        <div class="alert alert-danger py-2 mb-3">
                            <ul class="mb-0 ps-3">
                                <?php $__currentLoopData = $errors->only(['name','email','password','phone','role']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $msgs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = $msgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li style="font-size:13px"><?php echo e($msg); ?></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
...
<div class="modal fade" id="archiveAllModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.users.archiveAll')); ?>" method="POST" id="archiveAllForm">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal fade" id="deleteAllModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.users.deleteAll')); ?>" method="POST" id="deleteAllForm">
                <?php echo csrf_field(); ?>
                <?php echo method_field('DELETE'); ?>
                <div class="modal-body">
...
<div class="modal fade" id="archiveSelectedModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.users.archiveSelected')); ?>" method="POST" id="archiveSelectedForm">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Archive Folder Name</label>
...
<div class="modal fade" id="deleteAllArchivedModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.users.deleteAllArchived')); ?>" method="POST" id="deleteAllArchivedForm">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="alert alert-danger">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Campfix\resources\views/admin/users.blade.php ENDPATH**/ ?>