...
<div class="login-container">
    ...
    <form method="POST" action="<?php echo e(route('resend.otp')); ?>" id="resendForm" style="text-align: center;">
        <?php echo csrf_field(); ?>
...
if (storedExpiryTime && !<?php echo json_encode(session('reset_timer'), 15, 512) ?>) {
