...
<h2>Archive Folder: <?php echo e($folder->name); ?></h2>
<p><?php echo e($folder->user_count); ?> users archived</p>
<?php $__env->stopSection(); ?>
...
<div class="container-fluid px-3">
    <div class="row mb-4">
        <div class="col-12 text-end">
            ...
            <a href="<?php echo e(route('admin.users', ['view' => 'archives'])); ?>" class="btn btn-secondary">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-success" title="Restore" onclick="showRestoreUserModal(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>')">
                                        <i class="fas fa-trash-restore"></i> Restore
                                    </button>
                                    <button type="button" class="btn btn-sm btn-danger" title="Delete" onclick="showDeleteUserModal('<?php echo e($user->uuid); ?>', '<?php echo e(addslashes($user->name)); ?>')">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to restore all <?php echo e($folder->user_count); ?> users from this folder?</p>
                <p class="text-muted">All users will be restored to the active users list.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <form action="<?php echo e(route('admin.users.restoreAllFolder', $folder->id)); ?>" method="POST" class="d-inline">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="restoreSelectedModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.users.restoreSelected')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Campfix\resources\views/admin/archive-folder-users.blade.php ENDPATH**/ ?>