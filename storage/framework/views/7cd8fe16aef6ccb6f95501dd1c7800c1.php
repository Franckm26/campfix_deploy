            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div style="cursor: pointer;" onclick="togglePendingApprovals()">
                        ...
                        <span class="badge bg-warning text-dark ms-2"><?php echo e($pendingEventsList->count()); ?> requests</span>
                        <i class="fas fa-chevron-down ms-2" id="pending-chevron"></i>
                    </div>
                    <a href="<?php echo e(route('events.pending')); ?>" class="btn btn-sm btn-warning">
                        <i class="fas fa-check-circle"></i> Review Now
                    </a>
                </div>
                <div class="card-body" id="pending-approvals-body" style="display: none;">
                    <?php if($pendingEventsList->count() > 0): ?>
                        <div class="approvals-list">
                            <?php $__currentLoopData = $pendingEventsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="approval-item">
                                <div class="d-flex align-items-start">
                                    <input type="checkbox" class="form-check-input me-3 mt-1" disabled>
                                    <div class="flex-grow-1">
                                        <div class="approval-title"><?php echo e($event->title); ?></div>
                                        <div class="approval-meta">
                                            <span class="me-3"><i class="fas fa-user text-muted me-1"></i><?php echo e($event->user->name ?? 'Unknown'); ?></span>
                                            <span class="me-3"><i class="fas fa-map-marker-alt text-muted me-1"></i><?php echo e($event->location); ?></span>
                                            <span><i class="fas fa-calendar text-muted me-1"></i><?php echo e(\Carbon\Carbon::parse($event->event_date)->format('M d, Y')); ?></span>
                                        </div>
                                    </div>
                                    <div class="text-end ms-3">
                                        ...
                                        ?>
                                        <?php if($daysUntil < 0): ?>
                                            <span class="badge bg-danger"><?php echo e(abs($daysUntil)); ?> days overdue</span>
                                        <?php elseif($isUrgent): ?>
                                            <span class="badge bg-warning text-dark"><?php echo e($daysUntil); ?> days left</span>
                                        <?php else: ?>
                                            <span class="text-muted small"><?php echo e(\Carbon\Carbon::parse($event->event_date)->format('M d')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="approval-actions mt-2">
                                    <a href="<?php echo e(route('events.pending')); ?>" class="btn btn-sm btn-outline-primary">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center py-3">
                    ...
                    <div>
                        <?php if(in_array($user->role, ['school_admin', 'academic_head', 'program_head', 'principal_assistant'])): ?>
            ...
            <form action="<?php echo e(route('events.store')); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="modal-event_date" name="event_date" min="<?php echo e(date('Y-m-d')); ?>" required>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
...
<script>
    ...
    const eventsData = <?php echo json_encode($upcomingEventsList ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Campfix\resources\views/dashboard/principal.blade.php ENDPATH**/ ?>