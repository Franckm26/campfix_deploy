...
<div class="container-fluid px-3">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link <?php echo e(($viewType ?? '') === 'archives' ? 'active' : ''); ?>" 
                ...
                <?php if(isset($archivedConcerns) && $archivedConcerns->count() > 0): ?>
                    <span class="badge bg-warning ms-1"><?php echo e($archivedConcerns->count()); ?></span>
                <?php endif; ?>
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link <?php echo e(($viewType ?? '') === 'deleted' ? 'active' : ''); ?>" 
                ...
                <?php if(isset($deletedConcerns) && $deletedConcerns->count() > 0): ?>
                    <span class="badge bg-danger ms-1"><?php echo e($deletedConcerns->count()); ?></span>
                <?php endif; ?>
            </button>
        </li>
        </ul>
    ...
    <div class="tab-content show" id="concernTabContent">
        ...
        <div class="tab-pane fade <?php echo e(($viewType ?? 'active') === 'active' ? 'show active' : ''); ?>" 
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('concerns.my')); ?>" class="row g-2 align-items-center" id="filterForm">
                        ...
                        <div class="col-auto">
                            <a href="<?php echo e(route('concerns.my', ['view' => 'active'])); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-times"></i></a>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                                        ...
                                        <tr data-id="<?php echo e($concern->id); ?>" data-view="active">
                                            ...
                                            <td>
                                                <span class="badge bg-<?php echo e($concern->priority == 'urgent' ? 'danger' : 
                                                    ...
                                                    <?php echo e(($concern->priority ? ucfirst($concern->priority) : 'Not Set')); ?>
                                            ...
                                            <?php if(auth()->user()->role === 'mis'): ?>
                                            <td>
                                                <?php if($concern->is_anonymous): ?>
                                                    Anonymous
                                                <?php else: ?>
                                                    <?php echo e($concern->user->name ?? 'Unknown'); ?>

                                                    <?php if($concern->user): ?>
                                                        <small class="text-muted">(<?php echo e($concern->user->role); ?>)</small>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </td>
                                            <?php endif; ?>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <?php if($concern->user_id == auth()->id() && $concern->status == 'Pending'): ?>
                                                    <button type="button" class="btn btn-sm btn-warning bg-transparent border-0" onclick="editConcern(<?php echo e($concern->id); ?>)" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <?php endif; ?>
                                                    <?php if($concern->status == 'Pending' && !$concern->assigned_to && $concern->created_at->diffInDays(now()) >= 1): ?>
                                                    <button type="button" class="btn btn-sm btn-primary bg-transparent border-0" onclick="sendFollowUp(<?php echo e($concern->id); ?>)" title="Send Follow-up">
                    ...
                    <!-- Pagination -->
                    <?php if(method_exists($concerns, 'hasPages') && $concerns->hasPages()): ?>
                    <div class="d-flex justify-content-center mt-3">
                        <?php echo e($concerns->appends(request()->query())->links('pagination::bootstrap-4')); ?>
        ...
        <div class="tab-pane fade <?php echo e(($viewType ?? '') === 'resolved' ? 'show active' : ''); ?>" 
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('concerns.my')); ?>" class="row g-2 align-items-center" id="resolvedFilterForm">
                        ...
                        <div class="col-auto">
                            <a href="<?php echo e(route('concerns.my', ['view' => 'resolved'])); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-times"></i></a>
                        </div>
                    </form>
                </div>
            </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $resolvedConcerns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr data-id="<?php echo e($concern->id); ?>" data-view="resolved">
                                            ...
                                            <?php endif; ?>
                                            <td><?php echo e($concern->updated_at->format('M d, Y')); ?></td>
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-sm btn-info bg-transparent border-0" onclick="viewConcern(<?php echo e($concern->id); ?>)" title="View">
                                                        <i class="fas fa-eye"></i>
        ...
        <div class="tab-pane fade <?php echo e(($viewType ?? '') === 'archives' ? 'show active' : ''); ?>" 
            ...
            <?php if(($viewType ?? '') === 'archives' || isset($archivedConcerns)): ?>
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('concerns.my')); ?>" class="row g-2 align-items-center" id="archiveFilterForm">
                        ...
                        <div class="col-auto">
                            <a href="<?php echo e(route('concerns.my', ['view' => 'archives'])); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-times"></i></a>
                        </div>
                    </form>
                </div>
            </div>
                                        ...
                                        <tr data-id="<?php echo e($concern->id); ?>" data-view="archive">
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('concerns.restore', $concern->id)); ?>" class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit" class="btn btn-sm btn-success bg-transparent border-0" title="Restore">
                                                            <i class="fas fa-trash-restore"></i>
                                                        </button>
                                                    </form>
                                                    <button type="button" class="btn btn-sm btn-danger bg-transparent border-0" onclick="softDeleteArchivedConcern(<?php echo e($concern->id); ?>)" title="Delete">
                                                        <i class="fas fa-trash"></i>
                                                    </button>
                                                </div>
                                            </td>
        ...
        <div class="tab-pane fade <?php echo e(($viewType ?? '') === 'deleted' ? 'show active' : ''); ?>"
            ...
            <!-- Filters for Deleted -->
            <?php if(($viewType ?? '') === 'deleted' || isset($deletedConcerns)): ?>
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('concerns.my')); ?>" class="row g-2 align-items-center" id="deletedFilterForm">
                        ...
                        <div class="col-auto">
                            <a href="<?php echo e(route('concerns.my', ['view' => 'deleted'])); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-times"></i></a>
                        </div>
                    </form>
                </div>
            </div>
                                        ...
                                        <tr data-id="<?php echo e($concern->id); ?>" data-view="deleted">
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('concerns.restore-deleted', $concern->id)); ?>" class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit" class="btn btn-sm btn-success bg-transparent border-0" title="Restore">
                                                            <i class="fas fa-trash-restore"></i>
                                                        </button>
...
function updateAutoDeletePeriod(days) {
    if (confirm('Set auto-delete period to ' + days + ' days? Concerns deleted longer than this will be automatically removed.')) {
        ...
        document.getElementById('autoDeleteDays').value = '<?php echo e($days ?? 15); ?>';
    }
}
</script>
<style>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const categoryIssues = {
        ...
        <?php if($cat->issues && count($cat->issues) > 0): ?>
        '<?php echo e(strtolower($cat->name)); ?>': <?php echo json_encode($cat->issues); ?>,
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    };
