                    ...
                    <?php if($announcements->count() > 0): ?>
                        ...
                        <div class="carousel-indicators">
                            <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ann): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button" data-bs-target="#annCarousel" data-bs-slide-to="<?php echo e($i); ?>" <?php echo e($i === 0 ? 'class=active aria-current=true' : ''); ?>></button>
                        ...
                        <div class="carousel-inner">
                            <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ann): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="carousel-item <?php echo e($i === 0 ? 'active' : ''); ?>">
                                    <div class="ann-slide-event" style="<?php echo e($bgStyle); ?>">
                                        <div class="ev-left">
                                            <div class="ev-badge">
                                                <i class="fas fa-check-circle"></i> Approved
                                            </div>
                                            <div class="ev-title"><?php echo e($ann->title); ?></div>
                                            <div class="ev-meta">
                                                <span><i class="fas fa-calendar-day"></i> <?php echo e(\Carbon\Carbon::parse($ann->event_date)->format('M d, Y')); ?></span>
                                                <?php if($ann->location): ?>
                                                <span><i class="fas fa-map-marker-alt"></i> <?php echo e($ann->location); ?></span>
                                                <?php endif; ?>
                                                <?php if($ann->category): ?>
                                                <span><i class="fas fa-tag"></i> <?php echo e($ann->getCategoryLabel() !== 'Unknown' ? $ann->getCategoryLabel() : ucfirst($ann->category)); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="ev-right">
                                            <?php if($ann->start_time && $ann->end_time): ?>
                                            <div>
                                                <div class="ev-detail-label">Time</div>
                                                <div class="ev-detail-val">
                                                    <?php echo e(\Carbon\Carbon::parse($ann->start_time)->format('g:i A')); ?> –
                                                    <?php echo e(\Carbon\Carbon::parse($ann->end_time)->format('g:i A')); ?>

                                                </div>
                                            </div>
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('events.calendar')); ?>" class="ev-view-btn">
                        ...
                        <div style="display:flex; flex-direction:column; gap:0;">
                            ...
                            <div style="display:flex; gap:12px; align-items:center; padding:11px 16px; border-bottom:1px solid var(--cal-border,#e2e8f0);">
                                ...
                                <div style="flex:1; min-width:0;">
                                    <div style="font-weight:700; font-size:13px; color:var(--cal-text,#1e293b); white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"><?php echo e($item->title); ?></div>
                                    <div style="display:flex; flex-wrap:wrap; gap:8px; font-size:11px; color:#6b7280; margin-top:2px;">
                                        <span><i class="fas fa-calendar-day me-1"></i><?php echo e(\Carbon\Carbon::parse($item->event_date)->format('M d, Y')); ?></span>
                                        <?php if($item->location): ?><span><i class="fas fa-map-marker-alt me-1"></i><?php echo e($item->location); ?></span><?php endif; ?>
                                        <?php if($item->start_time && $item->end_time): ?><span><i class="fas fa-clock me-1"></i><?php echo e(\Carbon\Carbon::parse($item->start_time)->format('g:i A')); ?> – <?php echo e(\Carbon\Carbon::parse($item->end_time)->format('g:i A')); ?></span><?php endif; ?>
                                    </div>
                                </div>
                                <a href="<?php echo e(route('events.calendar')); ?>" style="flex-shrink:0; font-size:11px; color:#1a8fc1; font-weight:600; text-decoration:none; white-space:nowrap;">
            ...
            <div class="card-modern">
                ...
                <div class="calendar-days">
                    ...
                    <?php for($i = 0; $i < 7; $i++): ?>
                        ...
                        ?>
                        <div class="calendar-day <?php echo e($isToday ? 'today' : ''); ?> <?php echo e($hasEvent ? 'has-event' : ''); ?>">
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            ...
            <div class="card-modern">
                <div class="projects-header">
                    ...
                    <a href="<?php echo e(route('concerns.my')); ?>" style="text-decoration: none; color: #5e5ce6; font-size: 13px; font-weight: 500;">View All</a>
                </div>
                ...
                <div class="projects-grid">
                    ...
                    <div class="project-card" onclick="window.location.href='<?php echo e(route('concerns.my')); ?>'">
                        ...
                        <div class="project-meta"><?php echo e($total); ?> reports</div>
                    </div>
                    
                    <div class="project-card" onclick="window.location.href='<?php echo e(route('concerns.my')); ?>?status=Pending'">
                        ...
                        <div class="project-meta"><?php echo e($pending); ?> awaiting review</div>
                    </div>
                    
                    <div class="project-card" onclick="window.location.href='<?php echo e(route('concerns.my')); ?>?status=Resolved'">
                        ...
                        <div class="project-meta"><?php echo e($resolved); ?> completed</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-modern">
                ...
                <?php if($recentConcerns->count() > 0): ?>
                    <div style="margin-bottom: 12px; font-size: 13px; font-weight: 600; color: #666;">
                        <span>▼</span> Latest Updates • <?php echo e($recentConcerns->count()); ?>

                    </div>
                    
                    <?php $__currentLoopData = $recentConcerns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="reminder-item" style="cursor: pointer;"
                         onclick="openConcernModal({
                             id: <?php echo e($concern->id); ?>,
                             title: <?php echo e(json_encode($concern->title ?? 'No Title')); ?>,
                             description: <?php echo e(json_encode($concern->description ?? '')); ?>,
                             location: <?php echo e(json_encode($concern->location ?? '')); ?>,
                             location_type: <?php echo e(json_encode($concern->location_type ?? '')); ?>,
                             room_number: <?php echo e(json_encode($concern->room_number ?? '')); ?>,
                             status: <?php echo e(json_encode($concern->status)); ?>,
                             priority: <?php echo e(json_encode($concern->priority ?? 'medium')); ?>,
                             category: <?php echo e(json_encode(optional($concern->categoryRelation)->name ?? 'Uncategorized')); ?>,
                             image: <?php echo e(json_encode($concern->image_path ? asset('storage/' . $concern->image_path) : null)); ?>,
                             resolution_notes: <?php echo e(json_encode($concern->resolution_notes ?? '')); ?>,
                             created_at: <?php echo e(json_encode($concern->created_at->format('M d, Y h:i A'))); ?>,
                             resolved_at: <?php echo e(json_encode($concern->resolved_at ? $concern->resolved_at->format('M d, Y h:i A') : null)); ?>,
                             assigned_to: <?php echo e(json_encode(optional($concern->assignedTo)->name ?? null)); ?>

                         })">
                        <div>
                            <div class="reminder-text"><?php echo e(Str::limit($concern->title ?? $concern->location, 60)); ?></div>
                            <div style="font-size: 11px; color: #999; margin-top: 4px;">
                                <span class="status-badge status-<?php echo e(strtolower(str_replace(' ', '-', $concern->status))); ?>"><?php echo e($concern->status); ?></span>
                                <span style="margin-left: 8px;"><?php echo e($concern->created_at->diffForHumans()); ?></span>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Campfix\resources\views/dashboard/index.blade.php ENDPATH**/ ?>