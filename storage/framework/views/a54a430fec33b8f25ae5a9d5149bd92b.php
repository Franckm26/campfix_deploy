        ...
        <div class="col-md-4">
            <div class="card bg-warning text-white">
                <div class="card-body">
                    ...
                    <h2><?php echo e($pendingEvents); ?></h2>
                    <a href="<?php echo e(route('events.pending')); ?>" class="text-white">Review Now</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-success text-white">
                <div class="card-body">
                    ...
                    <h2><?php echo e($approvedEvents); ?></h2>
                    <a href="<?php echo e(route('events.calendar')); ?>" class="text-white">View Calendar</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    ...
                    <h2><?php echo e($totalConcerns); ?></h2>
                    <a href="<?php echo e(route('admin.reports')); ?>" class="text-white">View Reports</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <?php if($pendingEvents > 0): ?>
                        <p>You have <?php echo e($pendingEvents); ?> event request(s) waiting for your approval.</p>
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-primary rounded-pill"><?php echo e($totalConcerns); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Unresolved Concerns
                            <span class="badge bg-warning rounded-pill"><?php echo e($pendingConcerns); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Upcoming Approved Events
                            <span class="badge bg-success rounded-pill"><?php echo e($approvedEvents); ?></span>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item d-flex justify-content-between align-items-start border-0 px-0 py-2">
                                <div class="ms-2 me-auto">
                                    <div class="fw-bold text-primary"><?php echo e($event->title); ?></div>
                                    ...
                                    <?php if($event->description): ?>
                                        <div class="text-muted small mt-1"><?php echo e(Str::limit($event->description, 80)); ?></div>
                                    <?php endif; ?>
                                </div>
                                <div class="text-end">
                                    <div class="badge bg-success mb-1"><?php echo e(\Carbon\Carbon::parse($event->event_date)->format('M d, Y')); ?></div>
                                    <div class="text-muted small">
