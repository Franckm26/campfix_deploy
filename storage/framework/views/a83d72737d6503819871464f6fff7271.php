...
unset($__errorArgs, $__bag); ?>" id="modal_title" name="title"
                            placeholder="e.g., Science Fair 2026, Faculty Meeting" required value="<?php echo e(old('title')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="modal_category" name="category" required>
...
unset($__errorArgs, $__bag); ?>" id="modal_court_type" name="court_type">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3" id="modal_avr_request_category_container" style="display: none;">
                            ...
                            <select class="form-select <?php $__errorArgs = ['avr_request_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="modal_avr_request_category" name="avr_request_category">
                                <option value="">Select category</option>
                                <option value="Non-academic">Non-academic</option>
                                <option value="Academic">Academic</option>
                            </select>
                            <?php $__errorArgs = ['avr_request_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
