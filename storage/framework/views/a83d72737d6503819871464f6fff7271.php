...
<!-- Favicon -->
<link rel="icon" type="image/png" href="<?php echo e(asset('Campfix/Images/logo.png')); ?>">
<link rel="shortcut icon" type="image/png" href="<?php echo e(asset('Campfix/Images/logo.png')); ?>">
...
<script src="<?php echo e(asset('js/event-request-modal.js')); ?>"></script>

<script>
// Pass facilities data to JavaScript
<?php if(isset($facilities)): ?>
window.facilitiesData = <?php echo json_encode($facilities, 15, 512) ?>;
<?php endif; ?>
