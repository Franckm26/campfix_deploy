...
<aside class="sa-sidebar" id="saSidebar">
    ...
    <nav class="sa-nav">
        ...
        <a href="<?php echo e(route('superadmin.dashboard')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.dashboard') ? 'active' : ''); ?>">
            <i class="fas fa-gauge-high"></i> Dashboard
        </a>
        <a href="<?php echo e(route('superadmin.analytics')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.analytics') ? 'active' : ''); ?>">
            <i class="fas fa-chart-line"></i> Analytics
        </a>

        <div class="sa-nav-section">Management</div>
        <a href="<?php echo e(route('superadmin.users')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.users*') ? 'active' : ''); ?>">
            <i class="fas fa-users"></i> All Users
        </a>
        <a href="<?php echo e(route('superadmin.concerns')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.concerns') ? 'active' : ''); ?>">
            <i class="fas fa-triangle-exclamation"></i> Concerns
        </a>
        <a href="<?php echo e(route('superadmin.reports')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.reports') ? 'active' : ''); ?>">
            <i class="fas fa-file-lines"></i> Reports
        </a>
        <a href="<?php echo e(route('superadmin.events')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.events') ? 'active' : ''); ?>">
            <i class="fas fa-calendar-days"></i> Events
        </a>
        <a href="<?php echo e(route('superadmin.categories')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.categories') ? 'active' : ''); ?>">
            <i class="fas fa-tags"></i> Categories
        </a>

        <div class="sa-nav-section">Audit</div>
        <a href="<?php echo e(route('superadmin.activity-logs')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.activity-logs') ? 'active' : ''); ?>">
            <i class="fas fa-list-check"></i> Activity Logs
        </a>
        <a href="<?php echo e(route('superadmin.superadmin-logs')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.superadmin-logs') ? 'active' : ''); ?>">
            <i class="fas fa-eye-slash"></i> Superadmin Logs
        </a>

        <div class="sa-nav-section">System</div>
        <a href="<?php echo e(route('superadmin.settings')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.settings') ? 'active' : ''); ?>">
            <i class="fas fa-gear"></i> Settings
        </a>
        <a href="<?php echo e(route('dashboard')); ?>" class="sa-nav-link">
    ...
    <div class="sa-sidebar-footer">
        <div class="sa-user-info">
            <div class="sa-avatar"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 1))); ?></div>
            <div>
                <div class="sa-user-name"><?php echo e(auth()->user()->name); ?></div>
...
<div class="sa-main">
    <div class="sa-topbar">
        <div style="display:flex;align-items:center;gap:12px">
            ...
            <h1 class="sa-page-title"><?php echo $__env->yieldContent('page_title', 'Dashboard'); ?></h1>
        </div>
        <div style="display:flex;align-items:center;gap:8px">
            <span style="font-size:12px;color:var(--sa-muted)"><?php echo e(now()->format('M d, Y')); ?></span>
    ...
    <div class="sa-content">
        <?php if(session('success')): ?>
            <div class="sa-alert sa-alert-success"><i class="fas fa-check-circle me-2"></i><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <?php if(session('error')): ?>
            <div class="sa-alert sa-alert-error"><i class="fas fa-circle-xmark me-2"></i><?php echo e(session('error')); ?></div>
        <?php endif; ?>
        <?php if(session('info')): ?>
            <div class="sa-alert sa-alert-info"><?php echo session('info'); ?></div>
        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\Campfix\resources\views/superadmin/layout.blade.php ENDPATH**/ ?>