...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/auth-first-login.css')); ?>">
</head>
<body>
    <div class="container">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body px-4 pb-4">
                        ...
                        <form method="POST" action="<?php echo e(route('auth.first-login-password.update')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter 10-digit mobile number (e.g., 9123456789)" required>
                                </div>
                                <small class="text-muted">Enter 10-digit mobile number (e.g., 9123456789) - This will be used for SMS OTP verification</small>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\Campfix\resources\views/auth/first-login-password.blade.php ENDPATH**/ ?>