...
<div class="container-fluid px-2 px-md-3">
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="card stat-card green h-100">
                <div class="card-body py-3 px-3">
                    ...
                    <h3 class="mb-0 fw-bold"><?php echo e($activeUsers); ?></h3>
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="card stat-card orange h-100">
                <div class="card-body py-3 px-3">
                    ...
                    <h3 class="mb-0 fw-bold"><?php echo e($archivedUsers); ?></h3>
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="card stat-card red h-100" onclick="document.getElementById('lockedModal').style.display='flex'" style="cursor:pointer" title="Click to view locked accounts">
                <div class="card-body py-3 px-3">
                    ...
                    <h3 class="mb-0 fw-bold text-danger"><?php echo e($lockedUsers); ?></h3>
                    <?php if($lockedUsers > 0): ?>
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="card stat-card purple h-100">
                <div class="card-body py-3 px-3">
                    ...
                    <h3 class="mb-0 fw-bold"><?php echo e($forceChangeUsers); ?></h3>
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="card stat-card blue h-100">
                <div class="card-body py-3 px-3">
                    ...
                    <h3 class="mb-0 fw-bold"><?php echo e($newUsersThisMonth); ?></h3>
                    <?php if($newUsersLastMonth > 0): ?>
                        <?php $diff = $newUsersThisMonth - $newUsersLastMonth; ?>
                        <small class="<?php echo e($diff >= 0 ? 'text-success' : 'text-danger'); ?>" style="font-size:11px">
                            <?php echo e($diff >= 0 ? '▲' : '▼'); ?> <?php echo e(abs($diff)); ?> vs last month
                        </small>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body px-3 py-2">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $usersByRole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $meta = $roleColors[$role] ?? ['bg' => 'bg-secondary', 'label' => ucfirst($role)]; ?>
                        <div class="mb-2">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <span class="badge role-badge <?php echo e($meta['bg']); ?>"><?php echo e($meta['label']); ?></span>
                                <span class="fw-semibold small"><?php echo e($count); ?></span>
                            </div>
                            <div class="trend-bar-wrap">
                                <div class="trend-bar <?php echo e($meta['bg']); ?>" style="width:<?php echo e(round(($count / $maxCount) * 100)); ?>%"></div>
                            </div>
                        </div>
        ...
        <div class="col-12 col-md-7">
            <div class="card h-100">
                ...
                <div class="card-body px-3 py-3">
                    <?php $trendMax = $registrationTrend->max('count') ?: 1; ?>
                    <div class="d-flex align-items-end gap-2" style="height:90px">
                        <?php $__currentLoopData = $registrationTrend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $pct = round(($t['count'] / $trendMax) * 100); ?>
                            <div class="flex-fill text-center d-flex flex-column align-items-center justify-content-end" style="height:100%">
                                <span class="small fw-semibold mb-1" style="font-size:11px"><?php echo e($t['count']); ?></span>
                                <div style="width:100%;height:<?php echo e(max($pct, 4)); ?>%;background:#0d6efd;border-radius:4px 4px 0 0;min-height:4px"></div>
                                <span class="text-muted mt-1" style="font-size:10px"><?php echo e($t['month']); ?></span>
                            </div>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center py-2 px-3">
            ...
            <a href="<?php echo e(route('admin.users')); ?>" class="btn btn-sm btn-outline-primary py-0 px-2" style="font-size:12px">View All</a>
        </div>
                ...
                <table class="table table-hover mb-0" style="font-size:13px">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $recentUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            ?>
                            <tr>
                                <td class="checkbox-col"><input type="checkbox" class="user-checkbox" value="<?php echo e($u->id); ?>"></td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <?php if($u->profile_picture): ?>
                                            <img src="<?php echo e(asset('storage/'.$u->profile_picture)); ?>" class="avatar-sm" style="object-fit:cover">
                                        <?php else: ?>
                                            <span class="avatar-sm text-white" style="background:<?php echo e($bg); ?>"><?php echo e($initials); ?></span>
                                        <?php endif; ?>
                                        <div>
                                ...
                                <td><span class="badge role-badge <?php echo e($meta['bg']); ?>"><?php echo e($meta['label']); ?></span></td>
                                <td>
                                    <?php if($u->is_archived): ?>
                                        <span class="badge bg-warning text-dark">Archived</span>
                                    <?php elseif($u->locked_until && now()->lessThan($u->locked_until)): ?>
                                        <span class="badge bg-danger">Locked</span>
                                    <?php elseif($u->force_password_change): ?>
                                        <span class="badge bg-secondary">Pending Reset</span>
                                    <?php else: ?>
                                        <span class="badge bg-success">Active</span>
                                    <?php endif; ?>
                                </td>
                                <td class="text-muted"><?php echo e($u->created_at->format('M d, Y')); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="row g-2 mb-3">
        ...
        <div class="col-6 col-md-3">
            <a href="<?php echo e(route('admin.logs')); ?>" class="card text-decoration-none text-center h-100 p-3">
                <i class="fas fa-clipboard-list fa-2x text-info mb-2"></i>
                <div class="small fw-semibold">Activity Logs</div>
            </a>
        </div>
        <div class="col-6 col-md-3">
            <a href="<?php echo e(route('admin.categories')); ?>" class="card text-decoration-none text-center h-100 p-3">
                <i class="fas fa-tags fa-2x text-warning mb-2"></i>
                <div class="small fw-semibold">Categories</div>
            </a>
        </div>
        <div class="col-6 col-md-3">
            <a href="<?php echo e(route('settings.index')); ?>" class="card text-decoration-none text-center h-100 p-3">
    ...
    <div class="card shadow-lg" style="width:95%;max-width:900px;max-height:90vh;display:flex;flex-direction:column;border-radius:12px;overflow:hidden">
        <div class="d-flex align-items-center justify-content-between px-4 py-3" style="background:#dc3545;color:#fff">
            <div>
                ...
                <small style="opacity:.85"><?php echo e($lockedUsers); ?> account(s) require attention</small>
            </div>
        ...
        <div style="overflow-y:auto;flex:1">
            <?php if($lockedUsersList->isEmpty()): ?>
                ...
                <table class="table table-hover mb-0" style="font-size:15px">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $lockedUsersList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <tr id="locked-row-<?php echo e($lu->id); ?>">
                                <td class="ps-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <?php if($lu->profile_picture): ?>
                                            <img src="<?php echo e(asset('storage/'.$lu->profile_picture)); ?>" class="avatar-sm" style="object-fit:cover">
                                        <?php else: ?>
                                            <span class="avatar-sm text-white" style="background:<?php echo e($bg); ?>"><?php echo e($initials); ?></span>
                                        <?php endif; ?>
                                        <div>
                                            <div class="fw-semibold"><?php echo e($lu->name); ?></div>
                                            <div class="text-muted" style="font-size:11px"><?php echo e($lu->email); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td><span class="badge bg-secondary"><?php echo e(ucfirst(str_replace('_', ' ', $lu->role))); ?></span></td>
                                <td class="text-danger fw-semibold"><?php echo e($lu->failed_login_attempts); ?></td>
                                <td>
                                    <button class="btn btn-sm btn-success" onclick="unlockUser('<?php echo e($lu->uuid); ?>', <?php echo e($lu->id); ?>, '<?php echo e(addslashes($lu->name)); ?>')">
...
document.getElementById('reauthSubmit').addEventListener('click', function () {
    ...
    fetch('<?php echo e(route("admin.reauth")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Campfix\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>