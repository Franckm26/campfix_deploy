    ...
    <div class="home-calendar-wrap">
        ...
        <div class="cal-right-panel">
            ...
            <div class="cal-list-card">
                ...
                <form method="GET" action="<?php echo e(route('events.calendar')); ?>" id="filterForm">
                    <input type="hidden" name="view" value="calendar">
                    <div class="mb-2">
                        <label class="form-label small">Event Types</label>
                        <div class="form-check form-check-sm">
                            <input class="form-check-input" type="checkbox" name="filter_types[]" value="event" id="type_event" <?php echo e(in_array('event', $filterTypes ?? []) ? 'checked' : ''); ?>>
                            <label class="form-check-label small" for="type_event">Events</label>
                        </div>
                        <div class="form-check form-check-sm">
                            <input class="form-check-input" type="checkbox" name="filter_types[]" value="facility" id="type_facility" <?php echo e(in_array('facility', $filterTypes ?? []) ? 'checked' : ''); ?>>
                            <label class="form-check-label small" for="type_facility">Facility Bookings</label>
                        </div>
                        <div class="form-check form-check-sm">
                            <input class="form-check-input" type="checkbox" name="filter_types[]" value="maintenance" id="type_maintenance" <?php echo e(in_array('maintenance', $filterTypes ?? []) ? 'checked' : ''); ?>>
                    ...
                    <div class="mb-2">
                        ...
                        <select class="form-select form-select-sm" name="filter_location" id="filter_location">
                            ...
                            <?php $__currentLoopData = $allLocations ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($location); ?>" <?php echo e(($filterLocation ?? '') == $location ? 'selected' : ''); ?>><?php echo e($location); ?></option>
    ...
    <div class="modal fade" id="importEventsModal" tabindex="-1" aria-labelledby="importEventsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <form method="POST" action="<?php echo e(route('events.import')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<script>
    ...
    async function fetchCalendarEvents() {
        try {
            const response = await fetch('<?php echo e(route("events.calendar.events")); ?>');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Campfix\resources\views/events/calendar.blade.php ENDPATH**/ ?>