        ...
        <div class="dashboard-card">
            ...
            <div class="task-section">
                <div class="task-section-header" onclick="toggleSection('inProgress')" style="cursor: pointer;">
                    ...
                    <span class="task-badge"><?php echo e($assignedReports->where('status', 'In Progress')->count()); ?></span>
                </div>

                <div id="inProgress-content">
                    <?php $__empty_1 = true; $__currentLoopData = $assignedReports->where('status', 'In Progress'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="task-item" onclick="viewReport(<?php echo e($report->id); ?>)">
                        <div class="task-checkbox"></div>
                        <div class="task-content">
                            <div class="task-title"><?php echo e($report->title ?? 'Report #' . $report->id); ?></div>
                            <div class="task-meta">
                                <span class="priority-badge priority-<?php echo e(strtolower($report->severity)); ?>">
                                    <?php echo e(ucfirst($report->severity)); ?>

                                </span>
                                <span><?php echo e($report->location); ?></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="task-section">
                <div class="task-section-header" onclick="toggleSection('toDo')" style="cursor: pointer;">
                    ...
                    <span>TO DO</span>
                    <span class="task-badge"><?php echo e($assignedReports->whereIn('status', ['Pending', 'Assigned'])->count()); ?></span>
                </div>

                <div id="toDo-content">
                    <?php $__empty_1 = true; $__currentLoopData = $assignedReports->whereIn('status', ['Pending', 'Assigned'])->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="task-item" onclick="viewReport(<?php echo e($report->id); ?>)">
                        <div class="task-checkbox"></div>
                        <div class="task-content">
                            <div class="task-title"><?php echo e($report->title ?? 'Report #' . $report->id); ?></div>
            ...
            <div class="task-section">
                <div class="task-section-header" onclick="toggleSection('completed')" style="cursor: pointer;">
                    ...
                    <span>COMPLETED</span>
                    <span class="task-badge"><?php echo e($resolvedCount); ?></span>
                </div>

                <div id="completed-content" style="display: none;">
                    <p class="text-muted small"><?php echo e($resolvedCount); ?> task(s) completed</p>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="dashboard-card">
                ...
                <div class="task-section-header">
                    ...
                    <span>TODAY</span>
                    <span class="task-badge"><?php echo e($assignedReports->where('status', '!=', 'Resolved')->count()); ?></span>
                </div>

                <?php $__empty_1 = true; $__currentLoopData = $assignedReports->where('status', '!=', 'Resolved')->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="reminder-item">
                    <div class="reminder-title"><?php echo e($report->title ?? 'Report #' . $report->id); ?></div>
                    <div class="reminder-time">
                        <i class="fas fa-clock"></i> 
                        <?php echo e($report->created_at->format('g:i A')); ?> - <?php echo e($report->location); ?>
...
function viewReport(id) {
    fetch('<?php echo e(route("reports.show", ":id")); ?>'.replace(':id', id), {
        method: 'GET',
        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Campfix\resources\views/dashboard/maintenance.blade.php ENDPATH**/ ?>