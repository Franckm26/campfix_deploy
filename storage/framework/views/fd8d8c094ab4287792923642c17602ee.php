...
<div class="settings-container">
    ...
    <div class="settings-tabs">
        <a href="#" class="settings-tab active" onclick="showTab(event, 'notifications')">
            <i class="fas fa-bell"></i> <?php echo e($isTagalog ? 'Mga Abiso' : 'Notifications'); ?>
            ...
            <div class="settings-body">
                <form action="<?php echo e(route('settings.notifications')); ?>" method="POST">
                    ...
                    <div class="settings-section">
                        <h5><?php echo e($isTagalog ? 'Mga Channel ng Abiso' : 'Notification Channels'); ?></h5>
                    ...
                    <button type="submit" class="btn-save"><?php echo e($isTagalog ? 'I-save ang Mga Setting ng Abiso' : 'Save Notification Settings'); ?></button>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="settings-card">
            ...
            <div class="settings-body">
                <form action="<?php echo e(route('settings.preferences')); ?>" method="POST">
                    ...
                    <div class="settings-section">
                        <h5><?php echo e($isTagalog ? 'Mga Rehiyonal na Setting' : 'Regional Settings'); ?></h5>
                        
                        <div class="setting-item">
                            <div class="setting-info">
                                <div class="setting-label"><?php echo e($isTagalog ? 'Wika' : 'Language'); ?></div>
                                <div class="setting-description"><?php echo e($isTagalog ? 'Piliin ang gusto mong wika' : 'Select your preferred language'); ?></div>
                            </div>
                            <select name="language" class="form-select form-select-sm" style="width: auto;">
                                ...
                                <option value="tl" <?php echo e($user->language == 'tl' ? 'selected' : ''); ?>>Filipino / Tagalog</option>
                            </select>
                        </div>
                        
                        <div class="setting-item">
                            <div class="setting-info">
                                <div class="setting-label"><?php echo e($isTagalog ? 'Timezone' : 'Timezone'); ?></div>
                                <div class="setting-description"><?php echo e($isTagalog ? 'Itakda ang iyong lokal na timezone' : 'Set your local timezone'); ?></div>
                            </div>
                            <select name="timezone" class="form-select form-select-sm" style="width: auto;">
                                <option value="Asia/Shanghai" <?php echo e($user->timezone == 'Asia/Shanghai' ? 'selected' : ''); ?>>Asia/Shanghai (UTC+8)</option>
                                <option value="Asia/Manila" <?php echo e($user->timezone == 'Asia/Manila' ? 'selected' : ''); ?>>Asia/Manila (UTC+8)</option>
                                <option value="UTC" <?php echo e($user->timezone == 'UTC' ? 'selected' : ''); ?>>UTC</option>
                            </select>
                        </div>
                        
                        <div class="setting-item">
                            <div class="setting-info">
                                <div class="setting-label"><?php echo e($isTagalog ? 'Format ng Petsa' : 'Date Format'); ?></div>
                                <div class="setting-description"><?php echo e($isTagalog ? 'Piliin kung paano ipapakita ang mga petsa' : 'Choose how dates are displayed'); ?></div>
                            </div>
                            <select name="date_format" class="form-select form-select-sm" style="width: auto;">
                                <option value="Y-m-d" <?php echo e($user->date_format == 'Y-m-d' ? 'selected' : ''); ?>>YYYY-MM-DD</option>
                                <option value="d/m/Y" <?php echo e($user->date_format == 'd/m/Y' ? 'selected' : ''); ?>>DD/MM/YYYY</option>
                                <option value="m/d/Y" <?php echo e($user->date_format == 'm/d/Y' ? 'selected' : ''); ?>>MM/DD/YYYY</option>
                            </select>
                        </div>
                        
                        <div class="setting-item">
                            <div class="setting-info">
                                <div class="setting-label"><?php echo e($isTagalog ? 'Bilang ng Items kada Pahina' : 'Items Per Page'); ?></div>
                                <div class="setting-description"><?php echo e($isTagalog ? 'Bilang ng mga item na ipapakita sa mga listahan' : 'Number of items to display in lists'); ?></div>
                            </div>
                            <select name="items_per_page" class="form-select form-select-sm" style="width: auto;">
                                <option value="5" <?php echo e($user->items_per_page == 5 ? 'selected' : ''); ?>>5</option>
                                <option value="10" <?php echo e($user->items_per_page == 10 ? 'selected' : ''); ?>>10</option>
                                <option value="15" <?php echo e($user->items_per_page == 15 ? 'selected' : ''); ?>>15</option>
                                <option value="20" <?php echo e($user->items_per_page == 20 ? 'selected' : ''); ?>>20</option>
                                <option value="25" <?php echo e($user->items_per_page == 25 ? 'selected' : ''); ?>>25</option>
                            </select>
                        </div>
                    </div>
                    
                    <button type="submit" class="btn-save"><?php echo e($isTagalog ? 'I-save ang Mga Kagustuhan' : 'Save Preferences'); ?></button>
                </form>
            </div>
        </div>
                ...
                <form action="<?php echo e(route('settings.security-misconfiguration')); ?>" method="POST">
                    ...
                    <div class="settings-section">
                        ...
                        <div class="setting-item">
                            ...
                            <select name="session_timeout_minutes" class="form-select form-select-sm" style="width: auto;">
                                <option value="15" <?php echo e($user->session_timeout_minutes == 15 ? 'selected' : ''); ?>>15 minutes</option>
                                <option value="30" <?php echo e($user->session_timeout_minutes == 30 ? 'selected' : ''); ?>>30 minutes</option>
                                <option value="60" <?php echo e($user->session_timeout_minutes == 60 ? 'selected' : ''); ?>>1 hour</option>
                                <option value="120" <?php echo e($user->session_timeout_minutes == 120 ? 'selected' : ''); ?>>2 hours</option>
                                <option value="240" <?php echo e($user->session_timeout_minutes == 240 ? 'selected' : ''); ?>>4 hours</option>
                                <option value="480" <?php echo e($user->session_timeout_minutes == 480 ? 'selected' : ''); ?>>8 hours</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="settings-section">
                        ...
                        <div class="setting-item">
                            ...
                            <label class="toggle-switch">
                                <input type="checkbox" name="security_notifications_enabled" value="1" <?php echo e($user->security_notifications_enabled ? 'checked' : ''); ?>>
                                <span class="toggle-slider"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="settings-section">
                        ...
                        <div class="setting-item">
                            ...
                            <select name="password_change_frequency_days" class="form-select form-select-sm" style="width: auto;">
                                <option value="30" <?php echo e($user->password_change_frequency_days == 30 ? 'selected' : ''); ?>>30 days</option>
                                <option value="60" <?php echo e($user->password_change_frequency_days == 60 ? 'selected' : ''); ?>>60 days</option>
                                <option value="90" <?php echo e($user->password_change_frequency_days == 90 ? 'selected' : ''); ?>>90 days</option>
                                <option value="180" <?php echo e($user->password_change_frequency_days == 180 ? 'selected' : ''); ?>>180 days</option>
                                <option value="365" <?php echo e($user->password_change_frequency_days == 365 ? 'selected' : ''); ?>>365 days</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="settings-section">
                    <div class="setting-item">
                        <div class="setting-info">
                            ...
                            <div class="setting-description"><?php echo e(ucfirst(str_replace('_', ' ', $user->role))); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-info">
                            ...
                            <div class="setting-description"><?php echo e($user->email); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-info">
                            ...
                            <div class="setting-description"><?php echo e($user->phone); ?></div>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="setting-item">
                        <div class="setting-info">
                            ...
                            <div class="setting-description"><?php echo e($user->created_at->format('F d, Y')); ?></div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Campfix\resources\views/settings/index.blade.php ENDPATH**/ ?>