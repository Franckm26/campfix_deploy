        ...
        <div class="faculty-main-col">
            ...
            <div class="welcome-card">
                ...
                <div id="welcomeCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4000">
                    ...
                    <?php if(isset($myEventRequests) && $myEventRequests->count()): ?>

                        
                        <div class="carousel-indicators">
                            <?php $__currentLoopData = $myEventRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button" data-bs-target="#welcomeCarousel" data-bs-slide-to="<?php echo e($i); ?>" <?php echo e($i === 0 ? 'class=active aria-current=true' : ''); ?>></button>
                        ...
                        <div class="carousel-inner">
                            <?php $__currentLoopData = $myEventRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="carousel-item <?php echo e($i === 0 ? 'active' : ''); ?>">
                                    <div class="slide-event" style="<?php echo e($bgStyle); ?>">
                                        <div class="ev-left">
                                            <div class="ev-badge status-approved">
                                                <i class="fas fa-check-circle"></i>
                                                Approved
                                            </div>
                                            <div class="ev-title"><?php echo e($req->title); ?></div>
                                            <div class="ev-meta">
                                                <span><i class="fas fa-calendar-day"></i> <?php echo e(\Carbon\Carbon::parse($req->event_date)->format('M d, Y')); ?></span>
                                                <?php if($req->location): ?>
                                                <span><i class="fas fa-map-marker-alt"></i> <?php echo e($req->location); ?></span>
                                                <?php endif; ?>
                                                <?php if($req->category): ?>
                                                <span><i class="fas fa-tag"></i> <?php echo e($req->getCategoryLabel() !== 'Unknown' ? $req->getCategoryLabel() : ucfirst($req->category)); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="ev-right">
                                            ...
                                            <div class="ev-detail-row">
                                                ...
                                                <div class="ev-detail-val">
                                                    <?php echo e(\Carbon\Carbon::parse($req->start_time)->format('g:i A')); ?> –
                                                    <?php echo e(\Carbon\Carbon::parse($req->end_time)->format('g:i A')); ?>
                                            ...
                                            <div class="ev-detail-row">
                                                ...
                                                <div class="ev-detail-val"><?php echo e($req->department); ?></div>
                                            </div>
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('events.my')); ?>" class="ev-view-btn">
                            ...
                            <div class="carousel-item active">
                                <div class="slide-empty">
                                    ...
                                    <div class="se-content">
                                        ...
                                        <a href="javascript:void(0)" class="se-btn" onclick="openEventModal('<?php echo e(now()->toDateString()); ?>')">
            ...
            <div class="quick-stats">
                <div class="stat-card">
                    ...
                    <div>
                        ...
                        <div class="stat-value"><?php echo e(isset($myEventRequests) ? $myEventRequests->count() : 0); ?></div>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div>
                        ...
                        <div class="stat-value"><?php echo e($approvedCount ?? 0); ?></div>
                    </div>
                </div>
                <div class="stat-card">
        ...
        <div class="cal-right-panel">
            ...
            <div class="mini-cal-card">
                ...
                <div style="margin-top:10px; text-align:right;">
                    <a href="<?php echo e(route('events.calendar')); ?>" style="font-size:12px; color:#4f6ef7; text-decoration:none; font-weight:600;">full calendar</a>
                </div>
            </div>
            ...
            <div class="upcoming-card">
                ...
                <?php else: ?>
                    <?php $__currentLoopData = $upcoming; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="upcoming-item">
                        <div class="upcoming-dot" style="background:#26a69a;"></div>
                        <div>
                            <div class="upcoming-title"><?php echo e($ev['title']); ?></div>
                            <div class="upcoming-date"><?php echo e(\Carbon\Carbon::parse($ev['start'])->format('M d, Y')); ?></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
...
function switchAnnTab(tab) {
    ...
    const calEvents = <?php echo json_encode($calendarEvents ?? [], 15, 512) ?>;
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const theme = '<?php echo e(auth()->user()->theme ?? "light"); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Campfix\resources\views/dashboard/faculty.blade.php ENDPATH**/ ?>